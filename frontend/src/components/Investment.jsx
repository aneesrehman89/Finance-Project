...
export default function InvestmentTracker() {
  ...
  const [investmentDataFromLocalStorage, setInvestmentDataFromLocalStorage] = useState([])
      ...
      console.log("investmentDataFromLocalStorage -----------", investmentDataFromLocalStorage);

      // const InvestmentMappingObj = investmentDataFromLocalStorage.financeData.investments;
      // console.log("InvestmentMappingObj", InvestmentMappingObj);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {investmentDataFromLocalStorage.map((inv, index) => (
                ...
                >
                  ...
                  <div className="mt-4">
                    <span
                      className={`inline-block px-3 py-1 text-sm font-semibold rounded-full ${inv.returns >= 0 ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                        }`}
                    >
